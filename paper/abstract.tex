...
at the beginning of the operation is quite large for many fueling strategies 
...
online feed system reactivity control during normal operation in the 
...
and transuranic (TRU) as a startup fuel. We applied five different absorbing 
...
negative or slightly positive, which makes the Shutdown Safety Devices (SSDs)  
ineffective for shutting down the reactor. Finally, the proposed design of the 
